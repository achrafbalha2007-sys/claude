...
\begin{frame}{Les trois profils que l'on compare}
  ...
  \begin{tikzpicture}[scale=1]
    ...
    \begin{scope}
      ...
      \node at (1.5,-0.4){\scriptsize $e(r)=e_0$};
    \end{scope}
    ...
    \begin{scope}[xshift=4cm]
      ...
      \node at (1.5,-0.4){\scriptsize $e(r)=e_c+(e_b-e_c)\,r^2$};
    \end{scope}
    % exponentiel
    \begin{scope}[xshift=8cm]
      ...
      \node at (1.5,-0.4){\scriptsize $e(r)=e_c\,e^{\alpha r}$};
    \end{scope}
  \end{tikzpicture}
  \end{center}
  \vspace{0.5cm}
  \centering $r$ = distance au centre (0 = centre, 1 = bord). \quad
  Contrainte : centre fin ($e_c\le 0{,}5$~mm), masse $\le 2{,}5\times$ l'uniforme.
\end{frame}
...
\begin{frame}{Résultats : le profil change tout}
  ...
  \column{0.55\textwidth}
    \begin{center}
    \figauto{fig_poutre_profils.png}{1.0}{profils + P(rupture)}
    \end{center}
...
\begin{frame}{Étape « optimisation » --- le meilleur compromis}
  \begin{columns}[c]
  \column{0.55\textwidth}
    \figauto{fig_poutre_optim.png}{1.0}{carte $P(e_c,e_b)$}
  \column{0.45\textwidth}
